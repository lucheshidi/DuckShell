...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "L:/programming/C++/DuckShell/_deps/minizip_src-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'L:/programming/C++/DuckShell/_deps/minizip_src-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'L:/programming/C++/DuckShell/_deps/minizip_src-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
